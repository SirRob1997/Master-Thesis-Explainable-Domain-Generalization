...
% {\huge
% \textcolor{darkred}{\textsc{\textbf{\univname}}}
% }
...
\large \textit{A thesis submitted in fulfillment of the requirements\\ for the degree of \degreename{} in Computer Science}\\[0.3cm] % University requirement text
\textit{in the}\\[0.4cm]
% \groupname\\
