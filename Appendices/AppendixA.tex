...
Since \Cref{tab:perfom} only shows the average performance for the respective dataset, we provide the full experimental results here for each of the domains across datasets. The results for the other algorithms besides \textsc{RSC}, \divcam, and \dtransformers are taken from \domainbed.
